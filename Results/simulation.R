...
res_est1 <- lapply(1:length(beta),function (i) t(replicate(m ,getOne(school1_undiCol_true,alpha[i],beta[i],p,O.c,z1[i,],alpha0, Nb, tiny))))
res_est2 <- lapply(1:length(beta),function (i) t(replicate(m ,getOne(school2_undiCol_true,alpha[i],beta[i],p,O.c,z2[i,],alpha0, Nb, tiny))))
res_est3 <- lapply(1:length(beta),function (i) t(replicate(m ,getOne(school3_undiCol_true,alpha[i],beta[i],p,O.c,z3[i,],alpha0, Nb, tiny)))) 
res_est4 <- lapply(1:length(beta),function (i) t(replicate(m ,getOne(school4_undiCol_true,alpha[i],beta[i],p,O.c,z4[i,],alpha0, Nb, tiny))))
